...
contract Aurora is ERC20Detailed, Ownable {
    ...
    string public _name = "Aurora";
    string public _symbol = "AURA";
    ...
    uint256 public auraInsuranceFundFee = 50;
    uint256 public sellFee = 25;
    uint256 public blackholeFee = 25;
    uint256 public nftFee = 15;
    uint256 public totalFee = liquidityFee.add(treasuryFee).add(auraInsuranceFundFee).add(blackholeFee);
    ...
    address public auraInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("Aurora", "AURA", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x77BF79Ba499CC1Ccc4E06C4d8B5bCCA04CAeB5E3;
        treasuryReceiver = 0x3166576D1293c6Af8e07Fdb7E83bdb5021f77fA3; 
        auraInsuranceFundReceiver = 0x9a7Dac091046Ec33C329E2269888D57bF907D3C3;
        blackhole = 0x14e85098610c2eF704786A2582cD323e2b6d0a60;
        nftFeeReceiver = 0xF8CCB10099E2f1972845E4f0760753E1A40Ab643;
    ...
    function swapBack() internal swapping {
        ...
        IERC20(USDC).transfer(treasuryReceiver, amountUSDCToTreasuryAndAIF.mul(treasuryFee).div(treasuryFee.add(auraInsuranceFundFee)));
        IERC20(USDC).transfer(auraInsuranceFundReceiver, amountUSDCToTreasuryAndAIF.mul(auraInsuranceFundFee).div(treasuryFee.add(auraInsuranceFundFee)));
    }

    function withdrawAllToTreasury() external swapping onlyOwner {

        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Aura token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = USDC;
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _auraInsuranceFundReceiver,
        address _blackhole,
        address _nftFeeReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        auraInsuranceFundReceiver = _auraInsuranceFundReceiver;
